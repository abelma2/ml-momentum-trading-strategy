...
![Cumulative performance vs. benchmark](CHART_1_Performance.png)
...
![Forward returns by signal decile](CHART_6_Signal_Buckets.png)
...
![Annual returns: strategy vs. benchmark](CHART_3_Annual_Returns.png)
...
For the full methodology and derivations, see [`STRATEGY_REPORT.md`](STRATEGY_REPORT.md) and the paper
